...
import type { CallRequest, GeneratedPrompt } from "./types.js";
...
export type WebhookMetadata = ReturnType<typeof createWebhookMetadata>;
export type WebhookAssistantConfig = ReturnType<typeof createWebhookAssistantConfig>;
