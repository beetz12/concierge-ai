...
export const metadata: Metadata = {
  ...
  description:
    "The narrative behind ConciergeAI and the AI Agents Assemble Hackathon.",
};
      ...
      <div className="relative overflow-hidden w-full py-20 lg:py-32 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 animate-fadeIn">
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
            ConciergeAI isn't just an app. It's a workforce. Designed to{" "}
            <span className="text-primary-300 font-semibold">think</span>,
            <span className="text-primary-300 font-semibold"> automate</span>,
            <span className="text-primary-300 font-semibold"> orchestrate</span>
            , and
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Powered by the "Infinity Stones" of the modern AI stack. Each
              technology provides a critical pillar of our agentic architecture.
            </p>
          </div>
        ...
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-surface to-abyss border border-surface-highlight p-12 text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
              ...
              Explore the code, verify the agents, and witness the next
              evolution of AI.
            </p>
            <a
...
function Card({
  ...
  return (
    <div className="bg-surface/40 backdrop-blur-sm border border-surface-highlight p-8 rounded-2xl hover:border-primary-500/30 transition-colors group">
      ...
      <h3 className="text-xl font-bold mb-3 text-slate-100 group-hover:text-primary-300 transition-colors">
        {title}
      </h3>
