 ...
 */
export function createBookingAssistantConfig(request) {
            ...
            structuredDataPlan: {
                ...
                schema: {
                    ...
                    properties: {
                        booking_confirmed: {
                            type: "boolean",
                            description: "Was the appointment successfully scheduled and confirmed?",
                        },
                        confirmed_date: {
                            type: "string",
                            description: "The confirmed appointment date (e.g., 'Tuesday, January 15th, 2025')",
                        },
                        confirmed_time: {
                            type: "string",
                        ...
                        confirmation_number: {
                            type: "string",
                            description: "Confirmation or reference number provided by the provider (if any)",
                        },
                        contact_name: {
                            type: "string",
                            description: "Name of the person you spoke to at the provider (if given)",
                        },
                        reschedule_needed: {
                            type: "boolean",
                            description: "Does the client need to call back to reschedule or provide more info?",
                        },
                        next_steps: {
                            type: "string",
                            description: "Any follow-up actions required before the appointment",
                        },
                        provider_notes: {
                            type: "string",
                            description: "Additional notes or requirements mentioned by the provider",
                        },
                        call_outcome: {
                            type: "string",
                            enum: [
