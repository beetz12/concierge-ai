 ...
 */
function isDirectTask(request) {
    return (request.serviceNeeded === "Direct Task" ||
 ...
 */
function createDirectTaskConfig(request) {
            ...
            structuredDataPlan: {
                ...
                schema: {
                    ...
                    properties: {
                        ...
                        resolution_details: {
                            type: "string",
                            description: "Specific details of the resolution (refund amount, new price, confirmation number, etc.)",
                        },
                        next_steps: {
                            type: "string",
 ...
 */
function createDynamicDirectTaskConfig(request, customPrompt) {
    const taskDescription = request.userCriteria;
    return {
 ...
 */
function createProviderSearchConfig(request) {
        ...
        analysisPlan: {
            summaryPlan: {
                ...
                messages: [
                    {
                        role: "system",
                        content: `Summarize: Was ONE person found with ALL required qualities? What are their rates? What is their soonest/earliest availability (specific date/time)? Does the provider meet all ${clientName}'s requirements?`,
                    },
                ],
            },
            structuredDataPlan: {
                ...
                schema: {
                    ...
                    properties: {
                        ...
                        earliest_availability: {
                            type: "string",
                            description: "Specific date/time when provider can come out (e.g., 'Tomorrow at 2pm', 'Friday morning', 'Next Monday')",
                        },
                        estimated_rate: {
                            type: "string",
                        },
 ...
 */
export function createAssistantConfig(request, customPrompt) {
